...
class OnboardingStep(models.Model):
    ...
    def action_open_sendcloud_onboarding_integration(self):
        ...
        action_name = (
            "delivery_sendcloud.action_sendcloud_onboarding_integration_wizard"
        )
    ...
    def action_sendcloud_onboarding_sync(self):
        """Called by onboarding panel."""
        action_name = "delivery_sendcloud.action_sendcloud_onboarding_sync_wizard"
        return self.env.ref(action_name).read()[0]

    @api.model
    def action_open_sendcloud_onboarding_warehouse_address(self):
        """Called by onboarding panel."""
        action_name = "delivery_sendcloud.action_sendcloud_onboarding_warehouse_wizard"
        return self.env.ref(action_name).read()[0]
