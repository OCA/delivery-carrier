...
class PostlogisticsAuth(models.TransientModel):
    ...
    def default_get(self, field_list):
        ...
        generate_label_url = icp.get_param("postlogistics.oauth.generate_label_url")
        configuration_done = (
            client_id and client_secret and authentication_url and generate_label_url
        )
    ...
    def generate_access_token(self):
        ...
        if response.status_code != 200:
            raise exceptions.UserError(
                _(
                    "Access token generation in error\n\n"
        ...
        icp.set_param("postlogistics.oauth.authentication_url", self.authentication_url)
        icp.set_param("postlogistics.oauth.generate_label_url", self.generate_label_url)
