...
try:
    ...
    class RewritePlugin(Plugin):
        ...
        def egress(self, envelope, http_headers, operation, binding_options):
            ...
            if node:
                node[0].text = etree.CDATA(self.value)
...
class DeliveryCarrier(models.Model):
    ...
    seur_price_method = fields.Selection(
        selection=[
            ('fixed', 'Fixed price'),
    ...
    def seur_soap_send(self, service, method, data):
        ...
        def create_rewrite_plugin(data):
            ...
            for _ in range(int(data[key].get('total_bultos') or 1)):
    ...
    def seur_rate_shipment(self, order):
        return getattr(
            self, '%s_rate_shipment' % self.seur_price_method)(order)
    ...
    def seur_create_shipping(self, picking):
        ...
        package_info = {
            ...
            'pais_consignatario': partner.country_id.code,
