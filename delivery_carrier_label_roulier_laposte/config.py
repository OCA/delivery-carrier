...
class LaposteConfigSettings(models.TransientModel):
    ...
    laposte_support_city = fields.Char(related='company_id.laposte_support_city')
    laposte_support_city_code = fields.Char(related='company_id.laposte_support_city_code')
    ...
    def onchange_company_id(self):
        ...
        laposte_login = company.laposte_login
        laposte_password = company.laposte_password
        laposte_support_city = company.laposte_support_city
        laposte_support_city_code = company.laposte_support_city_code

    def button_send_image_to_printer(self, cr, uid, ids, context=None):
        """ Implement your own method according to printing solution
        """
        return LaposteConfig().get_image_data()
