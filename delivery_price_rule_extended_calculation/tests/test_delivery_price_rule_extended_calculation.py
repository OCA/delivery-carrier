...
class TestDeliveryCost(common.TransactionCase):
    def setUp(self):
        ...
        self.undiscounted_delivery = self.env.ref(
            "delivery_price_rule_untaxed.undiscounted_delivery_carrier"
        )
    ...
    def test_undiscounted(self):
        self.sale_undiscounted_delivery_charges = self.SaleOrder.create(
            {
                "partner_id": self.partner_18.id,
                "partner_invoice_id": self.partner_18.id,
                "partner_shipping_id": self.partner_18.id,
                ...
                "carrier_id": self.undiscounted_delivery.id,
            }
        )
