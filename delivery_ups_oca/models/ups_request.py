...
class UpsRequest(object):
    def __init__(self, carrier):
        ...
        self.token_expipration_date = self.carrier.ups_token_expiration_date
    ...
    def _process_reply(
        ...
        if (
            not self.token
            or not self.token_expipration_date
            or (self.token_expipration_date <= datetime.datetime.now())
        ):
            self._get_new_token()
        data = data or {}
        headers = {
